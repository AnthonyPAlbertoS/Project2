...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Universidad Tecnologica De Panamá ");

        jLabel2.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Facultad De Ingeneria En Sistemas Computacionales ");

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Licenciatura En Desarrollo Y Gestión De Software");
        ...
        jLabel5.setText("Desarrollo De Software II");

        jLabel6.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Prosesora: Maria Tejedor");

        jLabel7.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Estudiantes: Anthony Perez  ");

        jLabel8.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Jose Carranza ");

        jLabel9.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Daniel Ubarte");

        jLabel10.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Josue Flores");

        jLabel11.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Alberto Carranza");

        jLabel12.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Alexandra De Gracia");

        jLabel13.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Proyecto 2");

        Pro1.setBackground(new java.awt.Color(255, 255, 255));
        Pro1.setFont(new java.awt.Font("Segoe UI Historic", 1, 14)); // NOI18N
        Pro1.setForeground(new java.awt.Color(0, 0, 0));
        Pro1.setText("Programa 1");
        ...
        Pro2.setBackground(new java.awt.Color(255, 255, 255));
        Pro2.setFont(new java.awt.Font("Segoe UI Historic", 1, 14)); // NOI18N
        Pro2.setForeground(new java.awt.Color(0, 0, 0));
        Pro2.setText("Programa 2");
        ...
        Pro3.setBackground(new java.awt.Color(255, 255, 255));
        Pro3.setFont(new java.awt.Font("Segoe UI Historic", 1, 14)); // NOI18N
        Pro3.setForeground(new java.awt.Color(0, 0, 0));
        Pro3.setText("Programa 3");
    ...
    private void Pro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Pro1ActionPerformed
        //Creando el acceso a otra interfaz. 
    ...
    private void Pro2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Pro2ActionPerformed
        // Creando el acceso a otra intefaz
        Programa2 pro2 = new Programa2();
        pro2.setVisible(true);
        pro2.setLocationRelativeTo(null);
    ...
    private void Pro3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Pro3ActionPerformed
        // Creando el acceso a otra ventana 
        Programa3 pro3 = new Programa3();
        pro3.setVisible(true);
        pro3.setLocationRelativeTo(null);
    ...
    private void exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitActionPerformed
        // Salir totalmente de le ejecucion del programa completo
        System.exit(0);
